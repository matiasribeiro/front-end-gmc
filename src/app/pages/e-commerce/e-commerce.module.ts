import { CaixaMetricasComponent } from './caixa/caixa.metricas.component';
...
import { GraficoIssueComponent } from './chartjs/graficoIssue.component';
...
@NgModule({
  ...
  declarations: [
    ...
    GraficoIssueComponent,
    ChartjsBarHorizontalComponent,
    ChartjsRadarComponent,

    CaixaMetricasComponent,
  ],
  providers: [
